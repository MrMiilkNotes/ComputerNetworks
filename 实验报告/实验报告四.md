...
![image-20191218214847989](实验报告四.assets/image-20191218214847989.png)
...
- 在抓到的包中虽然有RST，但是接收方和发送方都不是这次传送的双方
...
​	使用‘http’过滤即可得到http报文，可以看到本机ip：172.16.52.0，服务器ip：223.252.214.105，http协议版本1.1，请求方法都为“GET”，本机一共发送4个报文，服务器回复四个报文。
...
​	观察其报文，发现它使用被动方式连接，在执行更改目录后出现了连接断开，然后重新登录的情况
